...
var data1 = [{Name: "Ben", Spent: 330, Year: 2014, "total": 1},
...
var xfilter = crossfilter(data1),
    yearDim = xfilter.dimension(d => d.Year),
    spendDim = xfilter.dimension(d => Math.floor(d.Spent / 10)),
    nameDim = xfilter.dimension(d => d.Name),
...
function resetData(ndx, dimensions) {
  ...
  var spenderChartFilters = spender.RowChart.filters();
